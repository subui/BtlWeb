<?php ob_start();
	...
	function updateUser(){
		...
		if(isset($_POST["username"]) && isset($_POST["password"]) && isset($_POST["hoKH"]) && isset($_POST["tenKH"]) && isset($_POST["diachi"]) && isset($_POST["sdt"]))
		{	
			...
			$phone = $_POST["sdt"];
			$mail = $_POST["email"];
			$number_contract = $_POST["number_hd"];
...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	    	...
	    	function showInfo(parameter){
	    		/*update*/
	    		document.formUpdate.id_kh.value = rowKH[parameter][0];
	    		document.formUpdate.username.value = rowKH[parameter][1];
	    		document.formUpdate.password.value = rowKH[parameter][2];
	    		document.formUpdate.hoKH.value = rowKH[parameter][3];
	    		document.formUpdate.tenKH.value = rowKH[parameter][4];
	    		document.formUpdate.diachi.value = rowKH[parameter][5];
	    		document.formUpdate.sdt.value = rowKH[parameter][6];
	    		document.formUpdate.email.value = rowKH[parameter][7];
	    		document.formUpdate.number_hd.value = rowKH[parameter][8];
	    		/*delete*/
	...
	<body>
		    	...
		    	<div class="col-lg-12"><br><br><br><br>
	                ...
	                <div class="panel panel-danger">
	                    <div class="panel-heading">
	                        ...
	                        <h5 id="notice_upd"><?php updateUser();?></h5>
	                        <h5 id="notice_del"><?php deleteUser();?></h5>
	                    </div>
	                    ...
	                    <div class="panel-heading panel_style">
		                    <div class="row">
	                        	...
	                        	<div class="col-sm-3">
	                        		<a href="../../modules/signup.php" name="addUser" class="btn btn-md btn-success btn-block" >Thêm mới một khách hàng</a>
	                   			</div>
	                   		</div>
                   		</div>
	                </div>
		...
		<div class="modal fade modal-style" id="myModal_1" role="dialog">
		    <form class="form_sign_1 form-signin" method="POST" action="" name="formDelete">
				<fieldset>
	            <br>
